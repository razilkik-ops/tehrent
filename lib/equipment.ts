...
export const equipment: Equipment[] = [
  ...
  },
  {
    ...
    category: "Мини-экскаваторы",
    shortDescription:
      "Бурение свай под ленту для забора, фундамент дома и других строительных работ.",
    hourlyPrice: 120,
    pricePerShift: 920,
    availability: "today",
    specs: {
  ...
  },
  {
    ...
    shortDescription:
      "Снятие плодородного слоя земли, обратная засыпка фундамента, погрузка строительного мусора на самосвал, планировка участка.",
    hourlyPrice: 85,
    pricePerShift: 680,
    availability: "today",
    specs: {
  ...
  },
  {
    ...
    category: "Мини-погрузчики",
    shortDescription:
      "Бурение свай, фундамент, посадка деревьев, планировка участка и другие строительные работы.",
    hourlyPrice: 120,
    pricePerShift: 960,
    availability: "today",
    specs: {
