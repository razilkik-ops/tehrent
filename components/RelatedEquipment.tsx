  ...
  return (
    <section className="container-page py-12">
      <div className="flex items-end justify-between gap-4">
        ...
        <a href="/catalog" className="hidden items-center gap-2 text-sm font-bold sm:flex">
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-3">
        {related.map((item) => (
          <article key={item.id} className="overflow-hidden rounded-[24px] bg-white shadow-card">
            <EquipmentVisual type={item.imagePlaceholderType} className="min-h-40 rounded-none" />
            <div className="p-5">
